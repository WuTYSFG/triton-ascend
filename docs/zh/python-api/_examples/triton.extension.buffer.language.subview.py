...
@triton.jit
def test_subview_kernel_2d(in_ptr0, out_ptr0, shape_0: tl.constexpr, shape_1: tl.constexpr,
                           offsets: tl.constexpr,
                           sizes_0: tl.constexpr,
                           sizes_1: tl.constexpr,
...
def test_subview(
    ...
    grid = (1,)
    test_subview_kernel_2d[grid](
        input_tensor, output_tensor,
        shape_0=src_shape[0], shape_1=src_shape[1],
        offsets=tuple(offsets),
        sizes_0=sizes[0], sizes_1=sizes[1],
